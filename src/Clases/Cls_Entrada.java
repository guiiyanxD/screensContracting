...
public class Cls_Entrada {
    ...
    public int registrarVariasSalidas(){
        Object variasEntradas[][];
        return 0;
    }
    
    public void ActualizarEntrada(String codigoProducto, int cantidad){
        try {
            String query= "UPDATE entrada SET ent_cantidad = ? where ent_pro_codigo = ?";
