...
public class Frm_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 230, 40));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 410, 230, 40));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ic_consultas.png"))); // NOI18N
        jButton2.setText("Orden de Trabajo");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Frm_BuscarOrdenDeTrabajo g = new Frm_BuscarOrdenDeTrabajo();
//        Frm_OrdenDeTrabajo1 f = new Frm_OrdenDeTrabajo1();
        contenedor.add(g);
        g.show();
