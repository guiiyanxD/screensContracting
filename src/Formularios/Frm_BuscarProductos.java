...
public class Frm_BuscarProductos extends javax.swing.JInternalFrame {
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if(Frm_Entrada.enviar == 1){
            ...
            Frm_Salida.enviar = 0;
            dispose();
        }else if(Frm_OrdenDeTrabajo1.enviar == 1){
            int row = tabla.getSelectedRow();
            Frm_OrdenDeTrabajo1.txt_codigo.setText(tabla.getValueAt(row, 0).toString());
            Frm_OrdenDeTrabajo1.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_OrdenDeTrabajo1.txt_cantidad.requestFocus();
            Frm_OrdenDeTrabajo1.enviar = 0;
            dispose();
